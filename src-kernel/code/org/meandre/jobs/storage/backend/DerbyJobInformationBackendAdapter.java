 ...
 *
 */
public class DerbyJobInformationBackendAdapter 
extends JobInformationBackendAdapter {

	/** The query map file */
	private static final String QUERY_MAP_FILE = "job_information_query_map_derby.xml";

	/** Initialize the query map */
	public DerbyJobInformationBackendAdapter() {
		super();
		try {
			Properties props = new Properties();
			props.loadFromXML(DerbyJobInformationBackendAdapter.class.getResourceAsStream(QUERY_MAP_FILE));
