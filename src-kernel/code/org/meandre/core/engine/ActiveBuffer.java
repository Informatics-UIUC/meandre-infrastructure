 ...
 * It is active because when an object is inserted in the buffer by a publisher,
...
public class ActiveBuffer {
	 ...
	 * @throws ActiveBufferException An exception occurred while acquiring the capacity semaphore
	 */
