...
/** This class is the one in charge of keeping track of what is going on during
 * the execution of a flow. It performs logging/provenance based on the provided interface
 * implementation provided during the construction of MrProbe.
 *
 * @author Xavier Llor&agrave;
 * @author Amit Kumar
 *            - Added portNames as the objects that are sent to the probeComponent
 */
