...
public class Store {
     ...
     */
    public static String BASE_REPOSITORY_STORE_URL = BASE_STORAGE_URL + "repository/";
	 ...
	 */
	public static String getSConfigPath() {
		return sConfigPath;
	}
	 ...
	 * @return the sConfigPath
	 */
	public static void setSConfigPath(String configPath) {
