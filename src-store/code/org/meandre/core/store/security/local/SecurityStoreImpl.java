...
public class SecurityStoreImpl implements SecurityStore {
     ...
     */
    public SecurityStoreImpl(Model model, Store store ) throws SecurityStoreException {
    ...
    public void flush() {
    	...
    	try {
			PrintStream ps = new PrintStream(new FileOutputStream(new File(store.getRealmFilename())));
