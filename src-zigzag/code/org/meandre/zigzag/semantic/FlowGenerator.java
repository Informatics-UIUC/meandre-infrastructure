...
public class FlowGenerator {
    ...
    public void init (String sName) {
        ...
        ps.println("All rights reserved by DITA, NCSA, UofI (2007-2013)");
        ...
        // Parallelization information for instances
     ...
     */
    public void generateMAU(String sFileName, String sBaseURL) throws ParseException {
        String sOutputFileName = sFileName.replaceAll(".zz$", ".mau");
        generateMAUToFile(sOutputFileName, sBaseURL);
    }
    ...
    * @throws ParseException Something went wrong
    */
   public void generateMAUToFile(String sOutputFileName, String sBaseURL) throws ParseException {
       ...
       FlowDescription fd = getFlowDescription(sOutputFileName, sBaseURL,true);
     ...
     */
    public FlowDescription getCurrentFlowDescription(String sBaseURL, boolean bParallelProcess) {
        return getFlowDescription("vcli-empty-file-name", sBaseURL, bParallelProcess);
    }
